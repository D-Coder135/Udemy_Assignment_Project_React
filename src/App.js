    ...
    <div className="App">
      ...
      <div className={style.MainContainer}>
        ...
        <div className={style.ProductData}>
          ...
          <div>
            <img className={style.ProductImage} src="https://imgur.com/iOeUBV7.png" alt='Red Colored Watch'/>
            <img className={style.ProductImage} src="https://imgur.com/PTgQlim.png" alt='Red Colored Watch'/>
            <img className={style.ProductImage} src="https://imgur.com/Mplj1YR.png" alt='Red Colored Watch'/>
            <img className={style.ProductImage} src="https://imgur.com/xSIK4M8.png" alt='Red Colored Watch'/>
          </div>
        </div>
      </div>
    </div>
